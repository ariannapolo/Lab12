...
public class RiversController {
    ...
    void doCompila(ActionEvent event) {
    	...
    	txtStartDate.setText(model.getFirstFlowDate(r).toString());
        this.txtEndDate.setText(model.getLastFlowDate(r).toString());
        this.txtNumMeasurements.setText(""+r.getNumMisurazioni());
        this.txtFMed.setText(""+r.getFMedio());
